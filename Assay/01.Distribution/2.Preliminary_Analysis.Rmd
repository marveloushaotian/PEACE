...
defensefinder_padloc_combined_data <- read.delim("../Results/2.Combined_Data/DefenseFinder_Padloc_Combine/Final_data.txt",header = T, check.names = F)
cctyper_data <- read.table("../Results/2.Combined_Data/Process_file/3.cctyper_data/cctyper_combined.txt",header = T,check.names = F)
...
argonaute_origin <- read.table("../Results/1.Original_Data/argonaute_origin_file.txt",header = T, check.names = F, sep = "\t")
argonaute_selected <- read.table("../Results/1.Original_Data/argonaute_selected_file.txt", header = T, check.names = F, sep = "\t")
